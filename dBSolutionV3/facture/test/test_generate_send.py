...
def main():
    ...
    try:
        ...
        print("❌ Le tenant 'dbsolution' n'existe pas. Créez-le avant de lancer ce script.")
        return

    # --- Tout ce qui touche le tenant doit être dans ce contexte ---
