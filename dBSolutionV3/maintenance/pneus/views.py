...
@never_cache
@login_required
def delete_pneus_view(request, pneu_id):
        ...
        try:
            with transaction.atomic():
                ...
                ACTION_SUPPRESSION_PNEUS = gettext_noop(
                    "Suppression du contrôle des pneus"
                )
            ...
            messages.success(
                request,
                _("Contrôle des pneus supprimé avec succès.")
            )
