...
from .views import choisir_autre_maintenance
from ..check_up.views import controle_total_view
from ..views import liste_maintenance_all, maintenance_detail_view, maintenance_tenant_view, maintenance_liste_view
