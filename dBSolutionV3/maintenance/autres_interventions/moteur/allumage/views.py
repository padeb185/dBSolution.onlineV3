                    ...
                    if km < ancien_kilometrage:
                        ...
                        with transaction.atomic():
                            ...
                            maintenance = Maintenance.objects.create(
                                ...
                                type_maintenance=Maintenance.TypeMaintenance.ALLUMAGE,
                            ...
                            allumage.voiture_exemplaire = (
                                exemplaire
                            )

                            allumage.maintenance = (
                                maintenance
                            )
                            ...
                            # ---------------------------------------------
                            allumage.kilometrage_variation = (
                                kilometrage_variation
                            )
                            ...
                            allumage.tech_last_maintained_by = (
                                request.user
                            )
            ...
            try:
                with transaction.atomic():
                    ...
                    if km is not None:
                        ...
                        allumage.kilometrage_variation = 0
...
@never_cache
@login_required
def delete_allumage_view(request, allumage_id):
    ...
    # ==================================================
    allumage = get_object_or_404(
        Allumage.objects.select_related(
            "voiture_exemplaire",
            "maintenance",
        ),
        id=allumage_id,
    ...
    exemplaire = allumage.voiture_exemplaire
    maintenance = allumage.maintenance
    ...
    if request.method == "POST":
        ...
        try:
            with transaction.atomic():
                ...
                # USER LOG
                # ==================================================
                ACTION_SUPPRESSION_ALLUMAGE = gettext_noop(
                    "Suppression du contrôle de l'allumage"
                )

                UserLog.objects.create(
                    utilisateur=request.user,
                    action=(
                        f"{ACTION_SUPPRESSION_ALLUMAGE} - "
                        f"{immatriculation}"
                    )
                )
            ...
            messages.success(
                request,
                _("Contrôle de l'allumage supprimé avec succès.")
            )
