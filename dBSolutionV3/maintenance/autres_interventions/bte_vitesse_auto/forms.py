...
class ControleBteVitesseAutoForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "kilometrage_variation" in self.fields:
            ...
            if (
                    ...
                    and self.instance.kilometrage_controle_boite_auto is not None
                    and self.exemplaire
                    and self.exemplaire.kilometres_chassis is not None
            ):
                variation = (
                        self.instance.kilometrage_controle_boite_auto
    ...
    def clean_kilometrage_controle_boite_auto(self):
