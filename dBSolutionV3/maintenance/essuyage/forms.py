...
class EssuyageForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "kilometrage_variation" in self.fields:
            ...
            if (
                    ...
                    and self.instance.kilometrage_essuyage is not None
            ):
    ...
    def clean_kilometrage_essuyage(self):
        km = self.cleaned_data.get("kilometrage_essuyage")
    ...
    def save(self, commit=True):
        ...
        if km is not None and voiture:
            instance.kilometrage_essuyage = km
