...
class VoitureFreinsAVForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            "taille_disque_av": _("Taille du disque avant (mm)"),
            "epaisseur_disque_av": _("Épaisseur du disque avant (mm)"),
            "epaisseur_min_disque_av": _("Épaisseur minimum du disque avant (mm)"),
