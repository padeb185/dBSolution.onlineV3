...
class Command(BaseCommand):
    help = "Ajoute des modèles pour d'autres marques mondiales pour le tenant 'rsr-spa'"

    def handle(self, *args, **options):
        # Récupération du tenant
        try:
            tenant = Societe.objects.get(slug='rsr-spa')
        except Societe.DoesNotExist:
            self.stdout.write(self.style.ERROR("Tenant 'rsr-spa' introuvable !"))
            return
        ...
        marques_modeles = {
            ...
            "Porsche": [
                ...
                {"modele": "550 Spyder", "variante": None, "portes": 2, "places": 2, "taille_reservoir": 60},
