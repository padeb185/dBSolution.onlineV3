...
class Command(BaseCommand):
    help = "Enrichit la base de données avec les modèles pour toutes les marques pour le tenant 'dbsolution'"
    ...
    def handle(self, *args, **options):
        ...
        marques_modeles = {
            ...
            # Ajoutez les autres marques comme dans votre script original...
        }
