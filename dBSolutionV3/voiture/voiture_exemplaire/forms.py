...
class VoitureExemplaireForm(forms.ModelForm):
    class Meta:
        ...
        fields = ('voiture_marque','voiture_modele', 'immatriculation', 'pays', 'numero_vin' , 'type_utilisation' ,'kilometres_chassis'
                      , 'kilometres_moteur', 'kilometres_derniere_intervention',
                   'mois_production', 'date_mise_en_circulation',
                  "est_avant_2010")

        widgets = {

            "numero_vin": forms.TextInput(attrs={"maxlength":17, "style":"text-transform:uppercase"}),
            "est_avant_2010": forms.CheckboxInput(),
