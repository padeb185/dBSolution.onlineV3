...
class VoitureFreinsARForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "taille_disque_ar": _("Diamètre des disques arrière (mm)"),
            "epaisseur_disque_ar": _("Épaisseur des disques arrière (mm)"),
            "epaisseur_min_disque_ar": _("Épaisseur minimum des disques arrière (mm)"),
